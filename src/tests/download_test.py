...
class TestDownload(unittest.TestCase):
    ...
    def test_lataa_yksi_lähde(self):
        ...
        sources = ({"source_id":1,"bibtex_key":"bibtex_key_1","title":"bibtex_title_1","year":"2020","author":"bibtex_author_1"},
                    {"source_id":2,"bibtex_key":"bibtex_key_2","title":"bibtex_title_2","year":"2021","author":"bibtex_author_2"})
